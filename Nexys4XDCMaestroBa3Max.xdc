## Archivo general para la tarjeta Nexys 4 
## Para usarla en tu proyecto:
## - Quita los "##" para de la linea que desees usar
## - renombre los puertos a usar ( en cada linea despues de "get ports" ) deacuerdo con tu archivo y el nombre sde sus señales 
